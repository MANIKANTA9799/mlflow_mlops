...
with mlflow.start_run() as parent:
    ...
    train_df = mlflow.data.from_pandas(train_df)#type:ignore
    ...
    test_df = mlflow.data.from_pandas(test_df)#type:ignore
    ...
    # Log the best model
    mlflow.sklearn.log_model(grid_search.best_estimator_, "random_forest")#type:ignore
